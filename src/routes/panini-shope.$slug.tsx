...
export const Route = createFileRoute("/panini-shope/$slug")({
  ...
  head: ({ loaderData }) => ({
    meta: loaderData
      ? [
          { title: `${loaderData.product.titulo} — Panini Shopee` },
...
const CREATOR_VIDEOS = [
  { src: "https://loja.ferrjhgf.shop/uploads/video_6a0a7381087667.64163451.mp4", avatar: avatarCarla, nome: "Carla Maria", caption: "Você vai ter o melhor preço comprando!" },
  { src: "https://loja.ferrjhgf.shop/uploads/video_6a0a7381087ae6.19381993.mp4", avatar: avatarNandy, nome: "Nandy zorzan", caption: "Unboxing das minhas figurinhas que peguei" },
  { src: "https://loja.ferrjhgf.shop/uploads/video_6a0a7381087ef6.99803322.mp4", avatar: avatarCalifornices, nome: "Califórnices", caption: "Olha que loucura recebi 40 e tantos combos" },
  { src: "https://loja.ferrjhgf.shop/uploads/video_6a0a7381088064.93282818.mp4", avatar: avatarJose, nome: "Jose Marcos", caption: "Chegou muito bem embalado, recomendo" },
  { src: "https://loja.ferrjhgf.shop/uploads/video_6a0a7381088262.63124527.mp4", avatar: avatarAndre, nome: "Andre Arthur", caption: "Coleção quase completa em poucos dias" },
  { src: "https://loja.ferrjhgf.shop/uploads/video_6a0a73810883c2.57410419.mp4", avatar: avatarJoyce, nome: "Joyce Lima", caption: "Surpreendi meu filho com esse álbum" },
  { src: "https://loja.ferrjhgf.shop/uploads/video_6a0a7381088544.38282211.mp4", avatar: avatarMateus, nome: "Matheus Alberto", caption: "Recomendo demais, vale cada centavo" },
  { src: "https://loja.ferrjhgf.shop/uploads/video_6a0a73810886b3.79854979.mp4", avatar: avatarJuan, nome: "Juan Andrade", caption: "Chegou rapidinho e bem completo" },
  { src: "https://loja.ferrjhgf.shop/uploads/video_6a0a7381088811.53234763.mp4", avatar: avatarJuliaRafael, nome: "Julia e Rafael", caption: "Surpresa perfeita para nossa coleção" },
];
    ...
    <div className="min-h-screen bg-zinc-100 text-zinc-900 sm:py-6">
      <div className="mx-auto max-w-[480px] bg-white pb-28 sm:rounded-2xl sm:shadow-xl sm:ring-1 sm:ring-zinc-200 sm:overflow-hidden">
        ...
        <header className="sticky top-0 z-20 flex items-center justify-between bg-white/95 px-4 py-3 backdrop-blur border-b border-zinc-100">
          <div className="flex items-center gap-2">
            <button className="p-1" onClick={() => navigate({ to: "/panini-shope" })}>
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={() => setOpen(true)} className="relative" aria-label="Abrir carrinho">
              ...
              {count > 0 && (
                <span className="absolute -top-2 -right-2 grid h-4 min-w-4 place-items-center rounded-full bg-[#ee4d2d] px-1 text-[10px] font-bold text-white">{count}</span>
              )}
            </button>
          </div>
        </header>
        ...
        {/* Price banner */}
        <div className="bg-gradient-to-r from-[#ee4d2d] to-[#f76c4f] px-4 py-2 text-white shadow-md">
          <div className="flex items-start justify-between gap-3">
            <div>
              <div className="flex items-center gap-2">
        ...
        {/* Coupon */}
        <button className="mx-3 mt-3 flex w-[calc(100%-1.5rem)] items-center justify-between rounded-xl bg-orange-50 px-3 py-3 text-[#ee4d2d]">
          <div className="flex items-center gap-2">
        ...
        <section className="mt-6 px-4">
          ...
          <div className="mt-3 flex items-center justify-between rounded-xl border border-zinc-200 p-3">
            <div className="flex items-center gap-3">
              <div className="grid h-12 w-12 place-items-center rounded-full bg-[#ee4d2d] text-lg font-bold text-white">P</div>
              <div>
                <div className="text-sm font-semibold">Panini — Album 2026</div>
                <div className="text-xs text-zinc-500">99.176 vendido(s)</div>
              </div>
            </div>
            <button onClick={() => navigate({ to: "/panini-shope" })} className="rounded-full border border-sky-500 px-4 py-1.5 text-sm font-semibold text-sky-600">Visitar</button>
          </div>
        </section>
      ...
      <div className="fixed inset-x-0 bottom-0 z-30 border-t border-zinc-200 bg-white">
        <div className="mx-auto flex max-w-[480px] items-center gap-3 px-3 py-2">
          <button onClick={() => navigate({ to: "/panini-shope" })} className="flex flex-col items-center justify-center text-[11px] text-zinc-700">
          ...
          <button
            onClick={goCheckout}
            className="flex-1 rounded-md bg-[#ee4d2d] text-sm font-bold text-white shadow-sm h-12 flex items-center justify-center"
          >
            Comprar Agora
          </button>
        </div>
