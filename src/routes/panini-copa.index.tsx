...
import { ChevronLeft, Search, Share2, ShoppingCart, Ticket, ShoppingBag } from "lucide-react";
        ...
        <section className="bg-white">
          <div className="flex items-center justify-between px-4 py-4">
            <div className="flex items-center gap-3">
              <img src={paniniLogo} alt="Panini" className="h-16 w-16 rounded-full border-2 border-transparent object-cover" />
              <div className="leading-tight">
                <div className="text-base font-semibold">Album 2026</div>
                <div className="text-[12px] text-zinc-500">99.176 vendido(s)</div>
              </div>
            </div>
          ...
          <div className="h-[5px] w-full bg-zinc-200" />
        </section>
          ...
          <div className="flex text-center text-sm">
            {([
              ...
              <button
                key={key}
                onClick={() => setTab(key)}
                className={`w-full py-2.5 ${tab === key ? "border-b-2 border-zinc-900 font-bold text-zinc-900" : "text-zinc-500"}`}
              >
                {label}
              </button>
            ))}
